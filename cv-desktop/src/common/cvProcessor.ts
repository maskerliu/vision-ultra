...
export class CVProcessor {
  protected _mode: IntergrateMode = IntergrateMode.WebAssembly
  ...
  protected gammaTable = new Uint8Array(256)
  protected lut: OpenCV.Mat
  protected processedImg: OpenCV.Mat
  protected tmpImg: OpenCV.Mat

  protected bgSubtractor: OpenCV.BackgroundSubtractorMOG2
  protected termCrit: OpenCV.TermCriteria
  protected trackWindow: OpenCV.Rect
  protected roiHist: OpenCV.Mat
  protected upper: OpenCV.Mat
  protected lower: OpenCV.Mat
  protected hsvVec: OpenCV.MatVector
  protected gamma: number = 1.0
